...
| :------------------------------------------------------- | :------------------------------------------------------------ | :------- |
| <img src="wiki/guides/img/studio.png" alt="Студия" width="64"/> | <img src="wiki/guides/img/studio-item.png" alt="Студия" width="64"/> | **Студия**<br>Позволяет создавать кастомные картины. Можно создать, бросив яйцо на ванильную картину. |
| <img src="wiki/guides/img/custom_painting_filled.png" alt="Картина" width="64"/> | <img src="wiki/guides/img/custom_painting-item.png" alt="Картина" width="64"/> | **Кастомная картина**<br>Можно разместить где угодно, в том числе на полах и потолках. Ее можно получить, нажав кнопку "Экспорт" в студии, для чего требуется 1 ванильная картина. |
| <img src="wiki/guides/img/paint_bucket.png" alt="Ведро для красок" width="64"/> | <img src="wiki/guides/img/paint_bucket-item.png" alt="Ведро для красок" width="64"/> | **Ведро для красок**<br>Позволяет сохранить дополнительные цвета в вашей палитре и может быть использовано как декорация. |
| <img src="wiki/guides/img/easel.png" alt="Мольберт" width="64"/> | <img src="wiki/guides/img/easel-item.png" alt="Мольберт" width="64"/> | **Мольберт**<br>Позволяет стильно отображать картины и перемещать их. |
| — | <img src="wiki/guides/img/brush.png" alt="Кисть" width="64"/> | **Кисть**<br>Получается при щелчке правой кнопкой мыши на студии. Позволяет взаимодействовать с меню. |
...
<div align="center">
<img src="wiki/guides/img/studio_annotated.png" alt="Студия" width="500"/>
</div>
...
# 🖼️ Мольберт
<div align="center">
<img src="wiki/guides/img/easels.gif" alt="Мольберт" width="500"/>
</div>
...
## Крафт
<div align="center">
<img src="wiki/guides/img/easel_recipe.png" alt="Мольберт" width="500"/>
</div>
...
# 🪣 Ведро с краской
<div align="center">
<img src="wiki/guides/img/paint_buckets.png" alt="Ведро с краской" width="500"/>
</div>
...
## Крафт
<div align="center">
<img src="wiki/guides/img/paint_bucket_recipe.png" alt="Ведро с краской" width="500"/>
</div>
